...
import (
	...
	clientcli "helios-core/cmd/heliades2/config/cli"
...
func appExport(
	...
	var injectiveApp *app.HeliosApp
	...
	if height != -1 {
		injectiveApp = app.NewHeliosApp(logger, db, traceStore, false, appOpts)

		if err := injectiveApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		injectiveApp = app.NewHeliosApp(logger, db, traceStore, true, appOpts)
	}
