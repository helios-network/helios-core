...
Transactions can also be generated, signed, and broadcasted through the `heliades` CLI. See [Using `heliades`](../tools/heliades/02_using.md) for an overview of the process, or the full [commands](../tools/heliades/commands#tx) for documentation on possible transactions types.
