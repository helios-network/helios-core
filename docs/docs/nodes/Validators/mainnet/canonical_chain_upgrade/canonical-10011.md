...
1. Verify you are currently running the correct version (`b578d018c8`) of `heliades`:
   ```bash
      heliades version
...
4. Verify you are currently running the correct version (`f77eb5cfd7`) of `heliades` after downloading the 10009 release:
    ```bash
   heliades version
