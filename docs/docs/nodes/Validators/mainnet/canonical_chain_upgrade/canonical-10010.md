...
Following [proposal 207](https://hub.helios.network/proposals/207/)
...
1. Verify you are currently running the correct version (`3c87354f5`) of `heliades`:
   ```bash
   heliades version
...
4. Verify you are currently running the correct version (`e218afcf7`) of `heliades` after downloading the 10009 release:
    ```bash
   heliades version
