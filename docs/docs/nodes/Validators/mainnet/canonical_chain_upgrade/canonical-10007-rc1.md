...
Following [proposal 170)](https://hub.helios.network/proposals/170/)
...
1. Verify you are currently running the correct version (`ef7f6f7a`) of `heliades`:
   ```bash
   heliades version
...
4. Verify you are currently running the correct version (`178f6dbb`) of `heliades` after downloading the 10007 release:
    ```bash
   heliades version
