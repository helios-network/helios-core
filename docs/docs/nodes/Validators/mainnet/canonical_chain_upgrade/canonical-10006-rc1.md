...
Following [proposal 159](https://hub.helios.network/proposals/159/)
...
1. Verify you are currently running the correct version (`568ce23`) of `heliades`:
   ```bash
   $ heliades version
   Version dev (568ce23)
...
4. Verify you are currently running the correct version (`ef7f6f7a`) of `heliades` after downloading the 10006-rc1 release:
    ```bash
   $ heliades version
