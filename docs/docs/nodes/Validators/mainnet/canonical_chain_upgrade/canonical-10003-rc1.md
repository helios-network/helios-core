...
1. Verify you are currently running the correct version (`096cbe5`) of `heliades`:
   ```bash
   $ heliades version
   commit: 096cbe5
...
4. Verify you are currently running the correct version (`260e526`) of `heliades` after downloading the 10003-rc1 release:
    ```bash
   $ heliades version
   Version dev (260e526)
