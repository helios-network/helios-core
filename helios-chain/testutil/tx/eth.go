...
func CreateEthTx(
	...
	baseFeeRes, err := apphelios.EvmKeeper.BaseFee(ctx, &evmtypes.QueryBaseFeeRequest{})
	if err != nil {
	...
	nonce := apphelios.EvmKeeper.GetNonce(ctx, fromAddr) + uint64(nonceIncrement) //nolint:gosec // G115
