...
yes 12345678 | heliades tx bank send genesis $SIGNER1 1000000inj --chain-id=injective-1 --yes
yes 12345678 | heliades tx bank send genesis $SIGNER2 1000000inj --chain-id=injective-1 --yes
yes 12345678 | heliades tx bank send genesis $SIGNER3 1000000inj --chain-id=injective-1 --yes
yes 12345678 | heliades tx bank send genesis $SIGNER4 1000000inj --chain-id=injective-1 --yes
yes 12345678 | heliades tx bank send genesis $SIGNER5 1000000inj --chain-id=injective-1 --yes
yes 12345678 | heliades tx bank send genesis $FEEDADMIN 1000000inj --chain-id=injective-1 --yes
...
yes 12345678 | heliades tx sign createfeed.json --from $SIGNER1 --chain-id=injective-1 --multisig=$FEEDADMIN > signature1.json
yes 12345678 | heliades tx sign createfeed.json --from $SIGNER2 --chain-id=injective-1 --multisig=$FEEDADMIN > signature2.json
yes 12345678 | heliades tx sign createfeed.json --from $SIGNER3 --chain-id=injective-1 --multisig=$FEEDADMIN > signature3.json

### merge signatures and make one transaction ###
yes 12345678 | heliades tx multisign createfeed.json feedadmin signature1.json signature2.json signature3.json --chain-id=injective-1 > signedcreatefeed.json
