...
import (
	...
	"helios-core/helios-chain/version"
)
...
func NewCreateSpotLimitOrderTxCmd() *cobra.Command {
	...
	cmd.Example = "heliades tx exchange create-spot-limit-order buy ETH/USDT 2.4 2000.1 my_order_1 --from=genesis --keyring-backend=file --yes"
	return cmd
}
...
func NewCancelSpotLimitOrderTxCmd() *cobra.Command {
	...
	cmd.Example = "heliades tx exchange cancel-spot-limit-order --market-id=ETH/USDT --order-hash=0xc66d1e52aa24d16eaa8eb0db773ab019e82daf96c14af0e105a175db22cd0fc8"
...
func NewCreateDerivativeLimitOrderTxCmd() *cobra.Command {
	...
	cmd.Example = `heliades tx exchange create-derivative-limit-order \
			--order-type="buy" \
			--market-id="ETH/USDT" \
...
func NewIncreasePositionMarginTxCmd() *cobra.Command {
	...
	cmd.Example = `heliades tx exchange increase-position-margin 0xf22dccace9d0610334f32637100cad2934528f81000000000000000000000000 0xf22dccace9d0610334f32637100cad2934528f81000000000000000000000000 "ETH/USDT PERP" 10000000`
	return cmd
}
...
func NewDecreasePositionMarginTxCmd() *cobra.Command {
	...
	cmd.Example = `heliades tx exchange decrease-position-margin 0xf22dccace9d0610334f32637100cad2934528f81000000000000000000000000 0xf22dccace9d0610334f32637100cad2934528f81000000000000000000000000 "ETH/USDT PERP" 10000000`
	return cmd
}
