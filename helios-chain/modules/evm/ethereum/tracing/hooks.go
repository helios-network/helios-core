...
import (
	...
	"helios-core/helios-chain/modules/evm/ethereum/types"
...
type (
	...
	*/
	...
	TxStartHook = func(vm *VMContext, tx *gotypes.Transaction, from common.Address)

	// TxEndHook is called after the execution of a transaction ends.
	TxEndHook = func(receipt *gotypes.Receipt, err error)
	...
	*/
	...
	GenesisBlockHook = func(genesis *gotypes.Block, alloc types.GenesisAlloc)
