...
1. **Request Withdrawal from Helios:** A user can initiate the transfer of assets from the Helios Chain to Ethereum by sending a `MsgSendToEth` transaction to the peggy module.
