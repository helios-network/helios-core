...
var (
	...
	pattern_Query_Attestation_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"peggy", "v1", "attestation", "nonce", "claim_hash"}, "", runtime.AssumeColonVerbOpt(false)))
