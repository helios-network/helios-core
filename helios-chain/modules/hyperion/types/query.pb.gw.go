...
var (
	...
	pattern_Query_GetPendingSendToEth_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"hyperion", "v1", "pending_send_to_eth"}, "", runtime.AssumeColonVerbOpt(false)))
	...
	pattern_Query_MissingPeggoNonces_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"hyperion", "v1", "missing_nonces"}, "", runtime.AssumeColonVerbOpt(false)))
)
