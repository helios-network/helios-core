...
var (
	...
	pattern_Msg_SendToEth_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"helios", "hyperion", "v1", "send_to_eth"}, "", runtime.AssumeColonVerbOpt(false)))
	...
	pattern_Msg_CancelSendToEth_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"helios", "hyperion", "v1", "cancel_send_to_eth"}, "", runtime.AssumeColonVerbOpt(false)))
