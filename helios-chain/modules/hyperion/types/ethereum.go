...
const (
	...
	// HyperionDenomSeparator is the separator for peggy denoms
	HyperionDenomSeparator = ""

	// ETHContractAddressLen is the length of contract address bytes
	ETHContractAddressLen = 20

	// HyperionDenomLen is the length of the denoms generated by the peggy module
...
// HyperionCoin returns the peggy representation of an ERC20 token
...
func NewHyperionDenomFromString(denom string) (HyperionDenom, error) {
	...
	peggyDenom := NewHyperionDenom(gethcommon.HexToAddress(addressHex))
