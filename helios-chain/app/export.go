...
import (
	...
	"helios-core/helios-chain/codec/types"
...
// file.
func (app *HeliosApp) ExportAppStateAndValidators(
	forZeroHeight bool,
...
func (app *HeliosApp) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) error {
