...
import (
	...
	cli "helios-core/helios-chain/x/revenue/v1/client/cli"
	keeper "helios-core/helios-chain/x/revenue/v1/keeper"
...
var (
	...
	// _ module.AppModuleSimulation = AppModule{} //! Fix this
)
