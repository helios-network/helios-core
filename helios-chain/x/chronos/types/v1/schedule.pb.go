...
// source: neutron/chronos/v1/schedule.proto
...
func init() {
	proto.RegisterType((*Schedule)(nil), "neutron.chronos.v1.Schedule")
	proto.RegisterType((*MsgExecuteContract)(nil), "neutron.chronos.v1.MsgExecuteContract")
	proto.RegisterType((*ScheduleCount)(nil), "neutron.chronos.v1.ScheduleCount")
}

func init() { proto.RegisterFile("neutron/chronos/v1/schedule.proto", fileDescriptor_cd4938034d592826) }
