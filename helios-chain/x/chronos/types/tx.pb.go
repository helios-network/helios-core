...
// source: neutron/chronos/tx.proto
...
type MsgAddSchedule struct {
	...
	ExecutionStage ExecutionStage `protobuf:"varint,5,opt,name=execution_stage,json=executionStage,proto3,enum=neutron.chronos.ExecutionStage" json:"execution_stage,omitempty"`
}
...
type MsgUpdateParams struct {
	// The address of the governance account.
	Authority string `protobuf:"bytes,1,opt,name=authority,proto3" json:"authority,omitempty"`
	// Defines the /x/chronos parameters to update.
	//
...
func init() {
	proto.RegisterType((*MsgAddSchedule)(nil), "neutron.chronos.MsgAddSchedule")
	proto.RegisterType((*MsgAddScheduleResponse)(nil), "neutron.chronos.MsgAddScheduleResponse")
	proto.RegisterType((*MsgRemoveSchedule)(nil), "neutron.chronos.MsgRemoveSchedule")
	proto.RegisterType((*MsgRemoveScheduleResponse)(nil), "neutron.chronos.MsgRemoveScheduleResponse")
	proto.RegisterType((*MsgUpdateParams)(nil), "neutron.chronos.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "neutron.chronos.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("neutron/chronos/tx.proto", fileDescriptor_c9e0a673aba8d6fd) }
...
func (c *msgClient) AddSchedule(ctx context.Context, in *MsgAddSchedule, opts ...grpc.CallOption) (*MsgAddScheduleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neutron.chronos.Msg/AddSchedule", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RemoveSchedule(ctx context.Context, in *MsgRemoveSchedule, opts ...grpc.CallOption) (*MsgRemoveScheduleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neutron.chronos.Msg/RemoveSchedule", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/neutron.chronos.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddSchedule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neutron.chronos.Msg/AddSchedule",
	}
...
func _Msg_RemoveSchedule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neutron.chronos.Msg/RemoveSchedule",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/neutron.chronos.Msg/UpdateParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "neutron.chronos.Msg",
	...
	Metadata: "neutron/chronos/tx.proto",
}
