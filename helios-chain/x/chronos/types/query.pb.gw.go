...
var (
	...
	pattern_Query_QueryGetCron_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"helios", "chronos", "cron", "id"}, "", runtime.AssumeColonVerbOpt(false)))
	...
	pattern_Query_QueryGetCronTransactionByNonce_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"helios", "chronos", "crons", "transaction", "nonce"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QueryGetCronTransactionReceiptLogsByBlockNumber_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"helios", "chronos", "crons", "transaction-receipt-logs", "block_number"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QueryGetCronTransactionReceiptsByBlockNumber_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"helios", "chronos", "block", "transaction-receipt", "block_number"}, "", runtime.AssumeColonVerbOpt(false)))
