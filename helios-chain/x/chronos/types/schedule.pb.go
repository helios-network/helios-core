...
// source: neutron/chronos/schedule.proto
...
func init() {
	proto.RegisterEnum("neutron.chronos.ExecutionStage", ExecutionStage_name, ExecutionStage_value)
	proto.RegisterType((*Schedule)(nil), "neutron.chronos.Schedule")
	proto.RegisterType((*MsgExecuteContract)(nil), "neutron.chronos.MsgExecuteContract")
	proto.RegisterType((*ScheduleCount)(nil), "neutron.chronos.ScheduleCount")
}

func init() { proto.RegisterFile("neutron/chronos/schedule.proto", fileDescriptor_49ace1b59de613ef) }
