...
async function main() {
    console.log("\n=== Auto-Registration Test Deployment Started ===\n");
    ...
    try {
        console.log("\nDeploying Contract for Auto-Registration Test...");
        ...
        console.log("  Waiting for deployment and auto-registration...");
        ...
        console.log("\nWaiting for auto-registration to process...");
        await new Promise(resolve => setTimeout(resolve, 5000));
        
        // Query revenue module to verify registration
        console.log("\nVerify registration with:");
        console.log(`heliades query revenue contract ${contractAddress}`);
        
        console.log("\n=== Deployment and Auto-Registration Test Completed ===\n");
    } catch (error) {
